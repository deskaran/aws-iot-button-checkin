/*
Lambda Function to use AWS IoT button to send check-in/check-out notifications for a AirBnB using SNS Topic instead of individual phone number
NOTE: Remember to create SNS Topic, and update IAM policy for the iotbutton role to allow SNS:Publish permission to the SNS ARN before proceeding.
*/
...
exports.handler = (event, context, callback) => {
    ...
    // Sends SMS to all phone numbers defined in the SNS Topic
    const params = {
        TopicArn: TOPIC_ARN,
        Message: doorMessage,
    };
